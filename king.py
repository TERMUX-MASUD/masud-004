...
\x1b[1;97m █▒▒  █▒▒  █▒▒    █▒▒   █▒▒       █▒▒     █▒▒     █▒▒ █▒▒    █▒▒
 ...
 \x1b[1;97m█▒▒       █▒▒ █▒▒         █▒▒   █▒▒ ▒▒     █▒▒▒▒▒    █▒▒▒▒▒    
'--------------------------------MASUD----------------------------------------'
 \x1b[1;97m[+] Author    :  MASUD RANA
 \x1b[1;97m[+] Developer :  MASUD
 \x1b[1;97m[+] Visit     :   https://wa.me/+8801871290994
 \x1b[1;97m[+] Contact.    : 💔👆🤝
  \x1b[1;97m[+] Whatsapp : +8801871290994
 \x1b[1;97m[+] Facebook : MD.MASUD RANA

\x1b[1;97m[+] 'GITUB ACCOUNT : TERMUX-MASUD
'----------------------------------------------------------------------------
...
def crack_file():
	...
	print(f'\r [{hh}<{P}] total MASUD- akun adalah {len(dump)}')
	atur_atur()
	...
	with tred(max_workers=30) as babas:
		for akun in id:
			...
			if 'mobile' in metode:
				...
				babas.submit(crack,idf,pwx,"m.facebook.com",awal)
	sleep(5)
	exit(f'\r [{hh}<{P}] crack telah selesai MASUD- OK:{ok} MASUD- CP:{cp} ')
